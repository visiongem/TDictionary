...
public class ToastMaker {
    ...
    public static void showShortToast(String msg) {
        showCustomTranslucentToast(TDApplication.getInstance(), msg, Toast.LENGTH_SHORT);
    }

    public static void showShortToast(int msgId) {
        showCustomTranslucentToast(TDApplication.getInstance(), msgId, Toast.LENGTH_SHORT);
    }

    public static void showLongToast(String msg){
        showCustomTranslucentToast(TDApplication.getInstance(), msg, Toast.LENGTH_LONG);
    }

    public static void showLongToast(int msgId){
        showCustomTranslucentToast(TDApplication.getInstance(), msgId, Toast.LENGTH_LONG);
    }
    ...
    private static void showToast(Context context, String msg, int duration) {
        ...
        if (null != context) {
            ...
            toast.setGravity(Gravity.CENTER, 0, TDApplication.getInstance().screenH / 4);
